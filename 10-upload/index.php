        ...
        <?php 
            ...
            if (!empty($_FILES['image'])){
                ...
                if(($_FILES['image']['error'] === 0 && $_FILES['image']['size'] < $maxSize && in_array($_FILES['image']['type'], $allowedTypes))) {
                    ...
                    // Récupèrer le fichier temporaire et le deplacer dans le dossier
                    ...
                    echo 'Veuillez envoyer un fichier au bon format (jpg, jpeg, png, gif) et à la bonne taille (100ko)';
                }
            }
        ?>
</body>
